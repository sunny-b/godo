...
// CDNService is an interface for managing DNS with the DigitalOcean API.
...
// FlushCache flushes the cache of an individual CDN. Requires a non-empty slice of file paths/wildcards
